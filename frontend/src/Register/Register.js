...
import "./Register.css";
import LogoImage from "../Images/SimpleTask.png";
  ...
  if (!registerStatus) {
    return (
      <main className="form-signin text-center">
        <Link to="/">
          <img src={LogoImage} alt="SimpleTask Logo" width="200" height="200" />
          <div className="row justify-content-center mb-4">
            <div>About SimpleTask</div>
          </div>
        </Link>
        <h1 className="h3 mb-3 fw-normal">Sign up for SimpleTask!</h1>
